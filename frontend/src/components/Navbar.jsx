        ...
        <div className="flex items-center gap-6 flex-1">
          ...
          >
            <div className="w-auto overflow-hidden">
              <svg
                aria-hidden="true"
                className="native w-[150px] h-[30px]"
                width="150"
                height="30"
                viewBox="0 0 150 30"
              >
        ...
        <div className="flex items-center gap-3">
          {currentUser ? (
            <>
              <Link
                to="/profile"
                className="flex items-center gap-2 hover:bg-gray-100 px-2 py-1 rounded-[3px] transition-colors"
                title="Profile"
              >
                <div className="w-6 h-6 bg-purple-500 rounded text-white flex items-center justify-center text-xs font-bold shadow-sm">
              ...
              <button
                onClick={logout}
                className="p-2 text-gray-600 hover:bg-gray-100 hover:text-red-500 rounded-[3px] transition-colors"
                title="Log out"
              >
                <LogOut size={20} />
              </button>
            ...
            <>
              <Link
                to="/login"
                className="px-3 py-1.5 bg-[#e1ecf4] text-[#39739d] hover:bg-[#b3d3ea] border border-[#7aa7c7] rounded-[3px] text-xs font-medium transition-colors whitespace-nowrap"
              >
                Log in
              </Link>
              <Link
                to="/register"
                className="px-3 py-1.5 bg-[#0a95ff] text-white hover:bg-[#0074cc] border border-transparent rounded-[3px] text-xs font-medium shadow-sm transition-colors whitespace-nowrap"
              >
                Sign up
              </Link>
            </>
